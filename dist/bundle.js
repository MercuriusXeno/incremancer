...
(() => {
    ...
    class q {
        constructor() {
            if (this.cooldownReduction = 0, this.timeExtension = 0, this.costReduction = 0, this.skeleton = new Xe, this.zombies = new Ae, this.humans = new Se, this.spellMap = new Map, 
                this.spells = [
                    new W(1, "Time Warp", "Speed up the flow of time for 30 seconds", "", 30, 30, 0, 
                          (function () { ne.getInstance().gameSpeed = 4 }), 
                          (function () { ne.getInstance().gameSpeed = 1 })), 
                    new W(2, "Energy Charge", "5x Energy rate for 20 seconds, cost 50 energy", "", 30, 20, 50, 
                          (function () { ne.getInstance().energySpellMultiplier = 5 }), 
                          (function () { ne.getInstance().energySpellMultiplier = 1 })), 
                    new W(3, "Detonate", "Turns your zombies into fast moving living bombs, cost 69 energy... nice", "", 20, 8, 69, 
                          (function () { (new q).zombies.detonate = !0 }), 
                          (function () { (new q).zombies.detonate = !1 })), 
                    new W(4, "Earth Freeze", "Freeze all humans in place preventing them from moving for 15 seconds, cost 75 energy", "", 20, 15, 75, 
                          (function () { (new q).humans.frozen = !0 }), 
                          (function () { (new q).humans.frozen = !1 })), 
                    new W(5, "Gigazombies", "For 5 seconds any zombies spawned will be giants with 10x health and attack damage, cost 100 energy", "", 60, 5, 100, 
                          (function () { (new q).zombies.super = !0 }), 
                          (function () { (new q).zombies.super = !1 })), 
                    new W(6, "Incinerate", "Burns humans near the skeleton champion", "Has a chance to cast Incinerate when attacking, burning all humans within a large radius of the Skeleton", 1, 10, 10, 
                          (function () { (new q).skeleton.incinerate(), this.timer = 1 }), 
                          (function () { })), 
                    new W(7, "Pandemic", "Causes plague to spread", "Has a chance to cast Pandemic when attacking, causing infected humans to spread the plague to each other for 20 seconds", 10, 20, 10, 
                          (function () { (new q).humans.pandemic = !0 }), 
                          (function () { (new q).humans.pandemic = !1 })), 
                    new W(8, "Part Storm", "Doubles parts", "Has a chance to cast Part Storm when attacking, doubling the parts production of your factory machines for 15 seconds", 10, 15, 10, 
        ...
        constructor() {
            if (this.gameModel = ne.getInstance(), this.spells = new q, this.skeleton = new Xe, this.partFactory = new se, this.types = {
                ...
                this.upgrades = [
                    ...
                    new le(9, "Sharpened Teeth", this.types.damage, this.costs.blood, 3e3, 1.125, 3, 100, "Your zombies bites do +3 damage with each rank of Sharpened Teeth.", null, 206), 
                    new le(11, "Razor Claws", this.types.damage, this.costs.blood, 28e3, 1.115, 5, 100, "Your zombies attacks do +5 damage with each rank of Razor Claws.", null, 211), 
                    ...
                    new le(10, "Thick Skull", this.types.health, this.costs.blood, 5e3, 1.125, 25, 100, "Your zombies gain +25 health with each rank.", null, 206), 
                    new le(12, "Battle Hardened", this.types.health, this.costs.blood, 32e3, 1.115, 40, 100, "Your zombies gain +40 health with each rank of Battle Hardened.", null, 211), 
                    ...
                    new le(13, "Blazing Speed", this.types.burningSpeedPC, this.costs.blood, 3e4, 1.125, .05, 50, "The humans are using torches to set your zombies on fire. Perhaps we can turn the tables on them? Each rank increases the movement and attack speed of burning zombies by 5%", null, 207), 
                    new le(14, "Spit it Out", this.types.spitDistance, this.costs.blood, 5e5, 1.3, 5, 50, "The first rank gives your zombies the ability to spit plague at enemies beyond normal attack range. Spit attacks do 50% zombie damage and infect the victim with plague. Subsequent ranks will increase the range of spit attacks.", null, 218), 
                    ...
                    new le(19, "Faster Harpies", this.types.harpySpeed, this.costs.blood, 1e8, 1.035, 2, 200, "These harpies are way too slow! We have to make them faster. Each rank increases harpy speed by 2", null, 222), 
                    new le(20, "Energy Rush", this.types.energyRate, this.costs.brains, 20, 1.05, .5, 500, "Melting brains down in your cauldron to make smoothies can be beneficial for your health. It also increases your energy rate by 0.5 per second for each rank.", null, null), 
                    ...
                    new le(28, "One is Never Enough", this.types.monsterLimit, this.costs.brains, 2e4, 1.1, 1, 50, "We're definitely going to need more than one golem to finish the job. Each rank increases your creature limit by 1", null, 220), 
                    ...
                    new le(40, "Bone Throne", this.types.energyCap, this.costs.bones, 50, 1.1, 10, 2000, "Sitting atop your throne of bones you can finally think clearly. Each rank increases maximum energy by 10.", null, null), 
                    new le(41, "Crown of Bones", this.types.energyRate, this.costs.bones, 200, 1.025, .2, 2000, "Not just dapper, these spikes help channel your energy. Each rank increases energy rate by 0.2 per second.", null, null), 
                    new le(42, "Bonebarrows", this.types.boneCollectorCapacity, this.costs.bones, 300, 1.1, 5, 30, "Your bone collectors are struggling to carry all these bones. Maybe it's time we gave them an upgrade? Each rank increases their carrying capacity by 5.", null, null), 
